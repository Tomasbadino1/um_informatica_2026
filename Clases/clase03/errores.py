...
#TypeError: Mezclas tipos de datos incompatibles, como sumar un número con un texto. Los strings son inmutables

#ValueError: Una función recibe un dato del tipo correcto pero con un valor absurdo o imposible de procesar 
#(ej. convertir letras a entero).
